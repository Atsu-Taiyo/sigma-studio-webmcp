...
/**
 * Converts an unambiguously Markdown-looking plain-text paste into canonical
 * text-flow blocks. Ordinary prose returns null and stays on Tiptap's native
 * plain-text / HTML paste path.
 */
export function parsePastedMarkdown(text: string): TextFlowBlock[] | null {
